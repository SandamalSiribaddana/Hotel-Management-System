              ...
              <View style={styles.card}>
                <View style={styles.cardTop}>
                  <View style={[styles.statusBadge, { backgroundColor: sm.bg }]}>
                    <Text style={[styles.statusText, { color: sm.text }]}>{item.status}</Text>
                  </View>
                ...
                {item.userId && (
                  <View style={styles.userRow}>
                    <Ionicons name="person-circle-outline" size={15} color="#aaa" />
                ...
                <View style={styles.actions}>
                  ...
                  >
                    <Ionicons name="swap-horizontal-outline" size={15} color="#6C63FF" />
      ...
      <Modal visible={!!selected} animationType="slide" transparent>
        <View style={styles.overlay}>
          <View style={styles.modal}>
              ...
              {["Pending", "Resolved"].map((s) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.statusChoice,
                      isCurrent && { backgroundColor: sm.bg, borderColor: sm.text },
                    ]}
                    onPress={() => handleUpdateStatus(selected._id, s)}
                    disabled={updating}
                  >
                    <Text style={[styles.statusChoiceText, isCurrent && { color: sm.text }]}>
                      {s}
                    </Text>
                  </TouchableOpacity>
                );
            ...
            {updating && <ActivityIndicator color="#6C63FF" style={{ marginTop: 10 }} />}
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  modalTitle: { fontSize: 20, fontWeight: "800", color: "#1A1A2E", marginBottom: 10 },
  modalMsg: {
    fontSize: 14,
    color: "#555",
    lineHeight: 20,
