  ...
  return (
    <View style={styles.container}>
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.emptyText}>You have no complaints.</Text>}
      />
...
const styles = StyleSheet.create({
  ...
  status: { fontSize: 13, fontWeight: "700", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, overflow: "hidden" },
  ...
  complaintImage: { width: "100%", height: 200, borderRadius: 12, marginBottom: 15 },
  actions: { flexDirection: "row", justifyContent: "flex-end", borderTopWidth: 1, borderTopColor: "#F4F6FB", paddingTop: 12 },
  editBtn: { paddingVertical: 8, paddingHorizontal: 16, marginRight: 10, borderRadius: 8, backgroundColor: "#EEF0FF" },
  editBtnText: { color: "#6C63FF", fontWeight: "700" },
  deleteBtn: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8, backgroundColor: "#FDECEA" },
  ...
  modalTitle: { fontSize: 20, fontWeight: "800", marginBottom: 20, color: "#1A1A2E" },
  input: {
    borderWidth: 1,
    borderColor: "#E0E5F2",
    borderRadius: 12,
